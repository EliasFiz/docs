...
The `playbackSpeed` parameter controls the speed of the audio playback. You can convey different personalities by changing the speed of the audio.
Generally we recommend setting the speed <b> between 0.9 and 1.1</b>. You would pass this in `CanopyConfig`.

## Visual Concepts
<p> 
Contact us <a href="mailto:elias@canopyai.xyz"> here </a>, if you want to support the appearance of your character. 
</p>
